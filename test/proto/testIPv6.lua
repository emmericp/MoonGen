describe("IPv6 class", function()
	...
	it("should return in correct byteorder", function()
		...
		local ip =  ffi.new("union ipv6_address")
	...
	it("should support ==", function()
		local ip = ffi.new("union ipv6_address")
		local ip2 = ffi.new("union ipv6_address")
		local ip3 = ffi.new("union ipv6_address")
	...
	it("should support in-place arithmetic", function()
		local ip1 = ffi.new("union ipv6_address")
		local ip2 = ffi.new("union ipv6_address")
		local ip3 = ffi.new("union ipv6_address")
		local ip4 = ffi.new("union ipv6_address")
